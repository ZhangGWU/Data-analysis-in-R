...
```{r}
getwd()
setwd("/Users/linyizhang/Desktop/Teaching/2024 fall Data analysis in R/Data-analysis-in-R")
...
#### Q4: get values of column 7, row 2
...
sum(Galldata1[1,2:length(Galldata1[1,])])

## repeat the above step for each row ###
TotalN<-c()
for (i in 1:length(Galldata1[,1])){
  
  TotalN[i]<-sum(Galldata1[i,2:length(Galldata1[1,])])
...
rep(1,Galldata1[1,"X21"])
length(rep(1,Galldata1[1,"X21"]))

rep(0,Galldata1[1,"X21"])
```
